    ...
    <nav
      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span
            className={`font-semibold text-xl ${theme === "dark" ? "text-white" : "text-slate-900"}`}>
            heimdall
          </span>
        </div>
    ...
    <section className="pt-32 pb-24 px-6 relative">
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        <p
          ...
          Like the northern lights, your content should captivate. Heimdall
          transforms how you create, schedule, and analyze with ethereal
          precision.
        </p>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div
                className={`h-40 rounded-xl backdrop-blur-sm border ${
                  theme === "dark" ? "border-teal-500/20" : "border-teal-200/60"
                }`}
                style={{
              ...
              <div
                className={`h-24 rounded-xl backdrop-blur-sm border ${
                  theme === "dark" ? "border-lime-500/20" : "border-lime-200/60"
                }`}
                style={{
...
function StatCard({ value, label }: { value: string; label: string }) {
  ...
  return (
    <div className="text-center p-6">
      ...
      <div
        className={`text-sm ${theme === "dark" ? "text-slate-500" : "text-slate-500"}`}>
        {label}
      </div>
    </div>
  );
  ...
  const features = [
    {
      ...
      description:
        "Let AI craft your posts while maintaining your unique voice. Generate weeks of content in minutes.",
    },
    {
      icon: RiPaletteLine,
      title: "Visual Design Suite",
      description:
        "Create stunning graphics with our built-in editor. No design skills required.",
    },
    {
      icon: RiTimeLine,
      title: "Smart Scheduling",
      description:
        "Our algorithm finds your optimal posting times. Maximize reach automatically.",
    },
    {
      icon: RiLineChartLine,
      title: "Deep Analytics",
      description:
        "Understand what works with detailed insights. Track growth across all platforms.",
    },
    {
      icon: RiGroupLine,
      title: "Team Workspaces",
      description:
        "Collaborate seamlessly with your team. Approvals, comments, and version history.",
    },
    {
    ...
    <section
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p
            className={`text-xl max-w-2xl mx-auto ${theme === "dark" ? "text-slate-400" : "text-slate-600"}`}>
            A complete toolkit for social media excellence, designed with
            ethereal precision.
          </p>
        </div>
  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2
          className={`text-3xl md:text-4xl font-bold mb-4 ${theme === "dark" ? "text-white" : "text-slate-900"}`}>
          Connect your entire stack
        </h2>
        <p
          className={`text-lg mb-12 ${theme === "dark" ? "text-slate-400" : "text-slate-600"}`}>
          Seamlessly integrate with all major platforms and tools you already
          use.
        </p>
            ...
            <div
              ...
              style={{
                boxShadow:
                  theme === "dark"
                    ? undefined
                    : `0 4px 20px -4px ${colors.primary[500]}1a`,
              }}>
              {name}
            </div>
          ))}
    ...
    <div className={`relative ${isPopular ? "scale-105 z-10" : ""}`}>
      ...
      <GlassCard hover={isPopular}>
        <div className="p-2">
          ...
          <p
            className={`text-sm mb-6 ${theme === "dark" ? "text-slate-400" : "text-slate-500"}`}>
            {description}
          </p>

          <div className="mb-6">
            <span
              className={`text-4xl font-bold ${theme === "dark" ? "text-white" : "text-slate-900"}`}>
              {price}
            </span>
            <span
              className={
...
function TestimonialCard({ quote, author, role, avatar }: Testimonial) {
  ...
  return (
    <GlassCard>
      ...
      <blockquote
        className={`leading-relaxed mb-6 ${theme === "dark" ? "text-slate-300" : "text-slate-600"}`}>
        "{quote}"
      </blockquote>
      <div className="flex items-center gap-3">
        <div
...
function TestimonialsSection() {
  ...
  const testimonials: Testimonial[] = [
    {
      quote:
        "The aurora-inspired interface makes managing social media feel almost meditative. Beautiful and functional.",
      author: "Maya Chen",
    ...
    {
      quote:
        "Heimdall helps us manage 50+ accounts without breaking a sweat. It's genuinely magical.",
      author: "Alex Rivera",
      role: "Agency Founder",
      avatar: "A",
    },
    {
      quote:
        "Went from posting randomly to having a real strategy. My engagement tripled in two months.",
      author: "Jordan Park",
...
function FaqItem({
  ...
  return (
    <div
      className={`border-b last:border-0 ${theme === "dark" ? "border-slate-700/50" : "border-slate-200/60"}`}>
      <button
        type="button"
        onClick={onToggle}
...
function FaqSection() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer:
        "Every plan comes with a 14-day free trial. No credit card required to start.",
    },
  ];
    ...
    <section className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <p
          ...
          Join 50,000+ creators and marketers who've transformed their social
          presence.
        </p>
        ...
        <p
          className={`mt-4 text-sm ${theme === "dark" ? "text-slate-500" : "text-slate-500"}`}>
    ...
    <footer
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p
              ...
              Light up your social presence with the most ethereal management
          ...
          <div>
            ...
            <ul
              className={`space-y-2 text-sm ${theme === "dark" ? "text-slate-500" : "text-slate-500"}`}>
        ...
        <div
          ...
          <p
            className={`text-sm ${theme === "dark" ? "text-slate-600" : "text-slate-400"}`}>
