...
function loadingKeys(prefix: string, count: number) {
...
export function LoadingState({
		...
		return (
			...
			>
				...
				<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
					{loadingKeys("page-metric", 4).map((key) => (
	...
	if (variant === "table") {
		return (
			<div className={cn("space-y-3", className)}>
				...
				{loadingKeys("table-row", count).map((key) => (
	...
	if (variant === "list") {
		return (
			<div className={cn("space-y-3", className)}>
				{loadingKeys("list-row", count).map((key) => (
	...
	return (
		<div className={cn("grid gap-4 sm:grid-cols-2 lg:grid-cols-3", className)}>
			{loadingKeys("card", count).map((key) => (
